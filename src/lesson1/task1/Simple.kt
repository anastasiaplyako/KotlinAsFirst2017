 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double =(3600*grad+60*min +sec)*0.000004848136811
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (pow(((percent*0.01)+1.0),3.0))*initial
